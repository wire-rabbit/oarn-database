...
class MigrationFamilyEnrollment(models.Model):
    """
    Tracks family enrollment records.
    """

    organization = models.ForeignKey('Organization')

    old_family_enrollment_id = models.CharField(max_length=30)

    family_enrollment = models.ForeignKey('FamilyEnrollment')

    family = models.ForeignKey('Family')

    class Meta:
        db_table = "migration_family_enrollment"
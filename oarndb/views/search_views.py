...
class AdultSearchList(generics.ListAPIView):
    ...
    - ?organization_id=1 - returns only results from the selected organization (the user must have read rights to view)
            ...
            if person_id_filter:
                ...
                if org_id_filter:
                    ...
                    query = AdultFamilyRelationship.objects.select_related(
                        ...
                        adult__person__organization__organization_id=org_id_filter
                    ).order_by(
                ...
                if org_id_filter:
                    ...
                    ).filter(family_id=family_id_filter).filter(
                        child__person__organization__organization_id=org_id_filter
                    ).order_by(
                ...
                if org_id_filter:
                    ...
                    adult_query = AdultFamilyRelationship.objects.select_related(
                        ...
                        adult__person__organization__in=Organization.objects.get_read_orgs(self.request.user)
                    ).filter(family_id=family_id_strict_filter).filter(
                        adult__person__organization__organization_id=org_id_filter
                    ).order_by(
                        'adult__person__last_name', 'adult__person__first_name'
                    )
                ...
                if org_id_filter:
                    ...
                    query = AdultFamilyRelationship.objects.select_related(
                        ...
                        adult__person__organization__in=Organization.objects.get_read_orgs(self.request.user)
                    ).filter(adult__person__first_name__istartswith=first_name_filter).filter(
                        adult__person__organization__organization_id=org_id_filter
                    ).order_by(
                        'adult__person__last_name', 'adult__person__first_name'
                    )
                ...
                if org_id_filter:
                    ...
                    query = AdultFamilyRelationship.objects.select_related(
                        ...
                        adult__person__organization__in=org_id_filter
                    )
                else:
                    query = AdultFamilyRelationship.objects.select_related(
                        'adult__person__ref_gender'
            ...
            if person_id_filter:
                ...
                if org_id_filter:
                    ...
                    query = ChildFamilyRelationship.objects.select_related(
                        ...
                        child__person__person_id=person_id_filter
                    ).filter(
                        child__person__organization__organization_id=org_id_filter
                    ).order_by(
                        'child__person__last_name', 'child__person__first_name'
                ...
                if org_id_filter:
                    ...
                    query = ChildFamilyRelationship.objects.select_related(
                        ...
                        child__person__organization__in=Organization.objects.get_read_orgs(self.request.user)
                    ).filter(child__person__first_name__istartswith=first_name_filter).filter(
                        child__person__organization__organization_id=org_id_filter
                    ).order_by(
                        'child__person__last_name', 'child__person__first_name'
                    )

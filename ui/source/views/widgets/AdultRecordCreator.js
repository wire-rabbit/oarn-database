...
(function (enyo, scope) {
     ...
     *
     * @event oarn.AdultRecordCreator#onAjaxError
     * @type {object}
     * @property {string} name - Name of the {@link oarn.AdultRecordCreator} control that
     * generated the event.
     ...
     *
     * @event oarn.AdultRecordCreator#onAjaxStarted
     * @public
     */
     ...
     *
     * @event oarn.AdultRecordCreator#onAjaxFinished
     * @public
     */
     ...
     *
     * @event oarn.AdultRecordCreator#onFamilyOptionPopupClosed
     * @public
     */

    /**
     *
     * @event oarn.AdultRecordCreator#onSelectedPersonChanged
     * @public
     */

    /**
     * [AdultRecordCreator]{@link oarn.AdultRecordCreator} allows a user to create a new adult linked to the currently selected family.
     *
     * @class oarn.AdultRecordCreator
     * @extends onyx.Popup
     * @public
     * @ui
     */
    enyo.kind(/**@lends oarn.AdultRecordCreator.prototype */{

        /**
         * @private
         */
        name: 'oarn.AdultRecordCreator',
        ...
        components: [
            {kind: 'onyx.Groupbox', style: 'width: 500px;', components: [
                {kind: 'onyx.GroupboxHeader', content: 'Create New Adult Record', class: 'oarn-groupbox-control'},
                            ...
                            {tag: 'table', components: [
                                ...
                                {tag: 'tr', components: [
                                    {tag: 'td', components: [{tag: 'label', content: 'Relationship:',
                                        attributes:[{'for':'selectAdultRelationship'}], classes: 'oarn-control oarn-groupbox-control'}]},
                                    {tag: 'td', components: [{name: 'selectAdultRelationship', kind: 'oarn.DataSelect', style: 'width:95%;',
                                        classes: 'oarn-control oarn-groupbox-control'}]}
                                ]}
                            ]}
                        ]}
                ...
                {name: 'confirmCreate', tag: 'table', showing: false, components: [
                    {tag: 'tr', components: [
                        {tag: 'td', components: [
                            {kind: 'onyx.Button', content: 'Confirm Adult Record Creation', classes: 'onyx-affirmative',
                                ontap: 'goConfirm'}
                        ]}
                    ]}
                ]},
        ...
        events: {
            ...
            onPersonCreated: '' // handled locally
        },
        ...
        create: function () {
            ...
            this.$.instructionsCell.setContent('This will create a new adult record and link it to this family. ' +
                'Although basic duplicates checking is performed, it is assumed that you have already verified ' +
                'that the adult is not in the system.');
            ...
            this.$.selectHelper.endpoints.push({endpoint: 'api/v1/ref/adult-family-relationship-types/',
                name: 'adult_create_relationships',parseWith: this.$.selectHelper.parseGenericRefTable});
        ...
        goCancel: function (inSender, inEvent) {
            this.hide();
            this.doFamilyOptionPopupClosed({'sender':'AdultRecordCreator'});
        },
        ...
        selectListsAcquiredHandler: function (inSender, inEvent) {
            ...
            this.$.selectAdultRelationship.options_list.empty();
            this.$.selectAdultRelationship.options_list.add(this.$.selectHelper.optionsLists['adult_create_relationships_options_list']);
        },
        ...
        checkDuplicates: function (inSender, inEvent) {
            ...
            var endpoint = 'api/v1/family/adult-search/?organization_id=' + org_id + '&fuzzy_match='+
                this.$.txtFirstName.getValue() + ' ' + this.$.txtLastName.getValue();
            var ajax = this.api.getAjaxObject(endpoint);
            ajax.go();
        ...
        goView: function (inSender, inEvent) {
            var newItem = new enyo.Model({'is_child':false});
            this.hide();
            this.doFamilyOptionPopupClosed({'sender':'AdultRecordCreator',
        ...
        processAdultResponse: function () {
            var postBody = {
                "adult": this.new_person_id,
                "family": this.get('.selectedFamilyID'),
                "ref_adult_family_relationship_type": this.$.selectAdultRelationship.getValue(),
        ...
        processFamilyResponse: function (inRequest, inResponse) {
            ...
            this.$.popupFactory.showInfo("Adult Record Created", "New Adult ID: " + this.new_person_id);
        },
